            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1">
                  <span className="text-gray-600 font-medium">Recruiter:</span>
                  <code className="bg-white px-2 py-1 rounded text-gray-800 text-xs">recruiter@demo.com / demo123</code>
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1">
                  <span className="text-gray-600 font-medium">Candidate:</span>
                  <code className="bg-white px-2 py-1 rounded text-gray-800 text-xs">candidate@demo.com / demo123</code>
                </div>
              </div>
            </div>
